    ...
    <div class="container">
      <div class="news__wrapper basic-flex">
        <div class="article__wrapper">
          ...
          <img src="{{ asset("img/article-img.png") }}" alt="Шавкат Мирзиёев строго предупредил хокимов всех уровней
          ">
        ...
        <div class="related-news">
          ...
          <div class="related-posts basic-flex">
            <div class="posts__item">
              <a href="#">
                <img src="{{ asset('img/top1.png') }}" alt="Image" class="posts__img">
            ...
            <div class="posts__item">
              <a href="#">
                <img src="{{ asset('img/top2.png') }}" alt="Image" class="posts__img">
            ...
            <div class="posts__item">
              <a href="#">
                <img src="{{ asset('img/top3.png') }}" alt="Image" class="posts__img">
