                ...
                <ul class="news__list basic-flex">
                    <li class="news__item">
                        <a href="#" class="basic-flex news__link">
                            <div class="news-image-wrapper"><img src="{{ asset('img/bottom1.png') }}" alt="Bottom Img"></div>
                    ...
                    <li class="news__item">
                    <a href="#" class="basic-flex news__link">
                        <div class="news-image-wrapper"><img src="{{ asset('img/bottom2.png') }}" alt="Bottom Img"></div>
                        <div class="news-box basic-flex">
                    ...
                    <li class="news__item">
                    <a href="#" class="basic-flex news__link">
                        <div class="news-image-wrapper"><img src="{{ asset('img/bottom3.png') }}" alt="Bottom Img"></div>
                        <div class="news-box basic-flex">
